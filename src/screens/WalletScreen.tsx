...
import { ActivityIndicator, Alert, FlatList, Linking, SafeAreaView, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native';
...
export function WalletScreen() {
  ...
  return (
      <ScrollView style={s.scroll}>
        ...
        {tokens.length > 0 && (
          <>
            <Text style={s.section}>Token ({tokens.length})</Text>
            <FlatList
              data={tokens}
